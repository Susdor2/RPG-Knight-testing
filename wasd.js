...
const itemData = {
    ...
    //enemy drops
    "Stick": {name: "Stick", level: 1, def: 0, atk: 1, hp: 0, toolType: "sword"},
    "Katana": {name: "Katana", level: 12, def: 0, atk: 23, hp: 0, toolType: "sword"},
    "Iron Longsword": {name: "Iron Longsword", level: 15, def: 0, atk: 25, hp: 0, toolType: "sword"},
    "Pitchfork": {name: "Pitchfork", level: 5, def: 0, atk: 10, hp: 0, toolType: "sword"},
    "Club": {name: "Club", level: 7, def: 0, atk: 20, hp: 0, toolType: "sword"},
    "Sand Hammer": {name: "Sand Hammer", level: 27, def: 0, atk: 45, hp: 0, toolType: "sword"},
}
...
const enemyData = {
    ...
    //desert
    "Mummy": {id: "Mummy", hp: 150, power: 14, def: 12, bounty: 65, xp: 45, level: 15, item: "", itemChance: 0},
    "Scorpion": {id: "Scorpion", hp: 130, power: 20, def: 10, bounty: 50, xp: 30, level: 18, item: "", itemChance: 0},
    "Skeleton": {id: "Skeleton", hp: 200, power: 25, def: 15, bounty: 110, xp: 65, level: 20, item: "", itemChance: 0},
    "Sand Golem": {id: "Sand Golem", hp: 350, power: 35, def: 25, bounty: 225, xp: 110, level: 35, item: "Sand Hammer", itemChance: 100},
}
...
function itemEnemyDrop(enemy) {
    ...
    if ((Math.random()*1000) < chance) {
        if (!you.inv.includes(item)) {
            you.inv[you.inv.length] = item
            createInvItem(item)
            getItem(item)
        }
    }
...
function createArea(area) {
    ...
    copy.id = area
    copy.innerHTML = area
    copy.onclick = function() {switchArea(area)}
    Teleport.appendChild(copy)
}
...
function saveGame() {
    ...
    for (let i=0; you.inv[i] != undefined && i < you.inv.length; i++) {save.you.inv.push(you.inv[i])}
    for (let i=0; itemData[skillItem[i]].unlocked; i++) {save.skillItems.push(skillItem[i])}
